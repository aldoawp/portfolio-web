...
@section('content')
    ...
    <div class="w-full h-full bg-gradient-to-br from-zinc-700 to-transparent border-[1px] border-white/15 rounded-3xl py-12 px-8 mb-4">
        ...
        <h1 class="text-3xl text-[#F4F4F4] font-semibold mb-8">PT Karyamega Putra Mandiri: POS Software</h1>
        
        {{-- Section: Additional Information --}}
        <div class="grid grid-cols-2 lg:flex lg:justify-around lg:items-center mb-8">
            {{-- Perusahaan --}}
            <div class="flex gap-2 text-[#CACACA] text-nowrap">
        ...
        <img src="{{ asset('img/ptkpm_cover.png') }}" alt="Placeholder image" class="object-cover w-full h-[20remA] lg:h-[30rem] rounded-2xl mb-12">
